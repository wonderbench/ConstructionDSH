 ...
 *
 * `Symbol.for` keeps the key's identity across module instances: a process
 * that loads `dsh-tools` on two planes (source and artifact) must still find
 * the scheduler on the service instance.
 * @internal
 */
