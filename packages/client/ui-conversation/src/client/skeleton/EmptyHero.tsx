...
/* Custom brand logo (served from the web dist root, apps/web/public),
   replacing the animated fish mark. */
const HERO_BRAND_LOGO_SRC = '/brand-logo1.png'


/**
 * Render the hero chrome (headline only; no composer, no workspace row).
 * Mode selection is the hero agent-preset chip rendered beside the workspace
 * picker, not a separate entry surface.
    ...
    <div className={css.root}>
      <div className={css.stack}>
        <div className={css.headline}>
          {/* Brand logo leading the headline, gap 10. */}
          <span className={css.fishHitbox}>
            {renderSlot('conversation.hero.brand.mark', { size: 34 }, {
              fallback: <img className={css.heroBrandLogo} src={HERO_BRAND_LOGO_SRC} alt="" />,
            })}
          </span>
