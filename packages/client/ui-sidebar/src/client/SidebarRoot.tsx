      ...
      >
        {!wide && !windowsTitlebar && (
          <span className={css.railMark} aria-hidden="true">
            {renderSlot('sidebar.brand.mark', { size: 24 }, { fallback: <img className={css.brandLogoRail} src="/brand-logo1.png" alt="" /> })}
          </span>
        )}
          ...
          const identity = (
            <span className={css.brandIdentity} aria-hidden="true">
              <span className={css.brandMark}>
                {renderSlot('sidebar.brand.mark', { size: 24 }, { fallback: <img className={css.brandLogoWide} src="/brand-logo2.png" alt="" /> })}
              </span>
              <span>
