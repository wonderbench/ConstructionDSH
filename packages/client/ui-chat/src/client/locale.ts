...
export const zh = {
  ...
  'message.stopped': '已停止',
  'message.denoise.viewExplanation': '查看说明',
  'message.denoise.hideExplanation': '收起说明',
...
export const en = {
  ...
  'message.denoise.viewExplanation': 'View explanation',
  'message.denoise.hideExplanation': 'Hide explanation',
