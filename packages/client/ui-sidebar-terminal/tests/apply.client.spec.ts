...
async function mountPlugin() {
  ...
  const theme = { preference: 'light' as const, fontSize: 14, outputDenoise: false, uiMode: 'business' as const, active: { id: 'light', colorScheme: 'light' as const, tokens: {} }, themes: [], revision: 0 }
