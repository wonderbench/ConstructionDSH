...
import {
  IconChecklistOutlineRegular, IconClockOutlineRegular, IconCompactOutlineRegular, IconDownloadOutlineRegular,
  IconGaugeOutlineRegular, IconGoalOutlineRegular, IconPaperPlaneOutlineRegular, IconPlanOutlineRegular,
  IconShieldOutlineRegular, PermissionIconFullAccessRegular,
...
const HOST_FACES: ReadonlyMap<BuiltinCommandName, HostFace> = new Map([
  ...
  hostLabelFace('construction-safety', IconShieldOutlineRegular),
  hostLabelFace('construction-quality', IconChecklistOutlineRegular),
  hostLabelFace('construction-cost', IconGaugeOutlineRegular),
  hostLabelFace('construction-schedule', IconClockOutlineRegular),
])
