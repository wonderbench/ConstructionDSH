...
| [construction.md](construction.md) | the construction subsystem: the `DocumentResult`/`SplitResult`/`CostResult`/`ScheduleResult` result types, the skill-minted `TaskBinding` semantics, and the bundle/profile composition |
