...
| [construction.md](construction.md) | the construction engineering assistant: read-only file tools with coverage reporting, PDF splitting, deterministic costing, CPM schedule calculation, report export, and the four business Skills |
