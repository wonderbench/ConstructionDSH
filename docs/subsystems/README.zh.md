...
| [construction.md](construction.zh.md) | construction 子系统：`DocumentResult`/`SplitResult`/`CostResult`/`ScheduleResult` 结果类型、由 Skill 铸造的 `TaskBinding` 语义，以及 bundle/profile 组合方式 |
