...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-construction-gantt': { kind: 'indirect', reason: 'The browser renders logged `construction_schedule_present` results as a read-only chart; the Host tool owns every model-facing schema and result.' },
  ...
  'packages/bundle/construction': { kind: 'indirect', reason: 'The bundle is a patch-list carrier; the composed construction-runtime and base rows own every model-facing behavior.' },
